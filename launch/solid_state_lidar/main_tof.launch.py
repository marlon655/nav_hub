...
def generate_launch_description():
    ...
    essential_linear = os.path.join(pkg_share, 'launch', 'solid_state_lidar/essential_tof.launch.py')
    nav_linear = os.path.join(pkg_share, 'launch', 'solid_state_lidar/nav_tof.launch.py')
